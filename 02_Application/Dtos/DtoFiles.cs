...
public sealed class UserInfoDto
{
    ...
    public UserStatusDto Status { get; init; } = UserStatusDto.Active;
    public DateTime CreatedAt { get; init; }
    public DateTimeOffset? LastLogin { get; init; }
    public List<string> Roles { get; init; } = [];
    public List<string> Claims { get; init; } = [];
}
public enum UserStatusDto { Active, Inactive, Locked }
...
public record RoleListDto : BaseRoleDto
{
    ...
    public string ParentCsv { get; set; } = string.Empty;
    public string ChildCsv { get; set; } = string.Empty;
    public string UserCsv { get; set; } = string.Empty;
}
...
public sealed record RoleHierarchyUpdateDto(
    Guid Id,
    Guid? ParentId,
    int OrderNo
);

public sealed record MinimalUserDto(
    Guid Id,
    string DisplayName,
    string? Email
);

public sealed record RoleUsersDto(
    Guid RoleId,
    List<MinimalUserDto> Users
);
